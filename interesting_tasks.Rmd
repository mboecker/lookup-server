...
```{r plots, echo=FALSE, fig.width=8, fig.height=6, fig.path="Figs/"}
...
t = data.frame(runs, n.runs, maxq, mad.runtime, mad.norm.runtime, var.norm.runtime)
knitr::kable(t, col.names = c("Learner", "Task ID", "# Runs", "max - 0.95q", "log. Runtime (MAD)", "log. Runtime / Scimark (MAD)", "log. Runtime / Scimark (Var.)"))
```
