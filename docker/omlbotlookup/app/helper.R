...
task_ids_paper = function() {
  ...
  # table 2
  c(3, 31, 37, 43, 49, 219, 3485, 3492, 3493, 3494, 3889, 3891, 3896, 3899, 3902, 3903, 3913, 3917, 3918, 3954, 14965, 10093, 10101, 9980, 9983, 9970, 9971, 9976, 9977, 9978, 9952, 9957, 9967, 9946, 9914, 14966, 34537)
}